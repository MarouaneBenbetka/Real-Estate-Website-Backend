...
def getAllAnnonces():
    return "here the controller for getting all annonces"

def getAnnonceDetails(annonce_id):
    return "here the controller for getting the details of a certain annonce"

def AddAnnonce():
    return "here the controller for adding annonce"
...
def DeleteAnnonce(annonce_id):
    return "this route is for delleting a certain annonce"
